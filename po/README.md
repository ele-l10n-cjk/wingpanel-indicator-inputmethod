# How to Add a Translation of This Indicator
...
And that's all! I'll check whether there is no problem in your pull request and if so I'll approve and merge your pull request! Your translation is released every time I release a new version of the indicator, so it is not always reflected when your pull request is merged. Please be patient.
...
* **If you would like to translate the indicator into multiple languages, please make separated PRs per languages.** It's not a good thing to include translations of more than 2 languages in your one pull request.
